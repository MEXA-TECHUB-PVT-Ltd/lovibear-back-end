...
exports.getUserRightSwipes= (req,res)=>{
    ...
    swipeModel.find({swipedBy:userId, swipedStatus:"right"} , function(err,result){
        if(!err){
            res.status(200).json({
...
exports.getUserLeftSwipes= (req,res)=>{
    ...
    swipeModel.find({swipedBy:userId, swipedStatus:"left"} , function(err,result){
        if(!err){
            res.status(200).json({
...
exports.deleteUserSwipe= (req,res)=>{
    ...
    swipeModel.deleteOne({swipeId}, function(err,result){
        try{
            console.log(result);
            if(result){
